...
var ITEM = {
	...
	"06": ["Hk-p Grenade launcher with commmon rounds",		   "Lança granadas com munição comuns - é extremamente eficiente contra a maioria dos inimigos do game.", 																																	   						"0px 168px 0px 335px",  "-722px", "0", "0", "6", "8", "0"],
	"07": ["Hk-p Grenade launcher with fire rounds",	 	   "Lança granadas com munição de fogo - é extremamente eficiente contra a maioria dos inimigos do game.", 																																	   						"0px 114px 0px 392px",  "-833px", "0", "0", "6", "8", "0"],
	"08": ["Hk-p Grenade launcher with acid rounds",	 	   "Lança granadas com munição de ácido - é extremamente eficiente contra o verme que você encontra no cemitério (Parque).", 																														   				"0px 58px 0px 446px",   "-943px", "0", "0", "6", "8", "0"],
	"09": ["Hk-p Grenade launcher with freeze rounds",	 	   "Lança granadas com munição de gelo - é extremamente eficiente nas batalhas contra o nemesis.", 																				   																					"0px 0px 0px 501px",   "-1055px", "0", "0", "6", "8", "0"],
	...
	"0e": ["M4A1 Assault rifle (Auto Mode)", 				   "Rifle de assalto M4A1 em modo Automático<br><br>É um bom rifle para quem está aprendendo a jogar o game, mas saiba que existem armas que são melhores do que essa.",															 		   						"0px 280px 0px 224px", "-500px", "1", "0", "11", "4", "1"],
	"0f": ["M4A1 Assault rifle (Manual Mode)", 				   "Rifle de assalto M4A1 em modo Manual<br><br>É um bom rifle para quem está aprendendo a jogar o game, mas saiba que existem armas que são melhores do que essa.",															 			   						"0px 227px 0px 280px", "-609px", "1", "0", "11", "5", "1"],
	...
	"11": ["Sigpro SP 2009 E", 							       "É a mesma Sigpro que o Carlos usa, porém com balas melhoradas.", 																																	   															"0px 114px 0px 392px",  "-833px", "1", "0", "2", "7", "1"],
	"12": ["Beretta M92F E",    							   "É a mesma M93F que a Jill usa, só que está com balas mais poderosas.<br><br>O som do disparo machuca mais do que a própria bala!", 																									   							"0px 58px 0px 446px",   "-943px", "1", "0", "3", "8", "1"],
	"13": ["Shotgun Benelli M3S E",        					   "Shotgun Benelli M3S<br><br>Se trata da mesma shotgun, porém com balas que tiram muito mais danos do que o comum.", 																																				"0px 0px 0px 501px",   "-1055px", "1", "0", "4", "9", "1"],
	"14": ["Mine thrower E",					 			   "Se trata de uma versão melhorada da lança granadas, com balas mais fortes",																								 																   						"0px 502px 0px 0px",     "-54px", "2", "0", "9", "0", "2"],
	...
	"21": ["Green Herb", 									   "Essa erva consegue curar apenas um pouco da sua vida, sem remover o status de envenenamento.", 																					   																				"0px 335px 0px 168px",  "-390px", "3", "1", "5", "3", "3"],
	...
	"23": ["Red Herb",										   "Ela sozinha não faz absolutamente nada - porém quando combinada com a verde, ela cura a sua vida completamente.", 																	   																			"0px 227px 0px 280px",  "-609px", "3", "1", "7", "5", "3"],
	"24": ["2x Green Herbs", 						    	   "Essa combinação consegue curar um pouco mais do que uma erva só, porém não recupera sua vida por completo e nem remove status de envenenamento.", 																												"0px 168px 0px 335px",  "-722px", "3", "1", "8", "6", "3"],
	...
	"29": ["All Herbs Mix",			     					   "Essa combinação cura a sua vida de forma completa, inclusive removendo o status de envenenamento do personagem atual.", 																		   																"0px 446px 0px 57px",  "-166px", "4", "1", "13", "1", "4"],
	"2a": ["First aid spray kit",	 						   "Kit que suporta até três unidades de first aid kit.",																													 																   						"0px 392px 0px 112px", "-277px", "4", "1", "14", "2", "4"],
	...
	"2c": ["(BOTU) Red Medal",								   "BOTU!<br><br>Uma moeda com o simbolo do \"Nosferatu\" na cor Vermelha.<br><br>Item descartado durante o processo de desenvolvimento.", 																					   										"0px 280px 0px 224px", "-500px", "4", "1", "16", "4", "4"],
	"2d": ["(BOTU) Yellow Medal", 							   "BOTU!<br><br>Uma moeda com o simbolo do \"Nosferatu\" na cor Azul.<br><br>Item descartado durante o processo de desenvolvimento.", 																						   										"0px 227px 0px 280px", "-609px", "4", "1", "17", "5", "4"],
	"2e": ["(BOTU) Blue Medal",								   "BOTU!<br><br>Uma moeda com o simbolo do \"Nosferatu\" na cor Dourada.<br><br>Item descartado durante o processo de desenvolvimento.", 																						   									"0px 168px 0px 335px", "-722px", "4", "1", "18", "6", "4"],
	...
	"30": ["(BOTU) Oil can labelled 'Giga Oil'",    		   "BOTU!<br><br>Esse item seria usado para fazer o item \"Mixed Oil\".<br><br>Item descartado durante o processo de desenvolvimento.", 																						   									"0px 58px 0px 446px",   "-943px", "4", "2", "0", "8", "4"],
	...
	"35": ["(BOTU) Cut Fire Hose",							   "BOTU!<br>Supostamente essa mangueira de incêndio era para estar cortada para fazer você dar mais voltas ainda!<br><br>Item descartado durante o processo de desenvolvimento.", 														   							"0px 335px 0px 168px",   "-390px","5", "2", "5", "3", "5"],
	...
	"3e": ["(BOTU) Fire hose tip", 							   "BOTU!<br><br>Item que suportamente seria usado para combinar com a mangueira de incêndio que está faltando o encaixe<br><br>Item descartado durante o processo de desenvolvimento.", 													 						"0px 392px 0px 112px", "-277px",  "6", "2", "14", "2", "6"], 
	...
	"42": ["Lighter (Closed)", 				  				   "Um isqueiro que está sem fluído.<br>Combine com o item Lighter oil para obter o isqueiro aberto.", 																																		 						"0px 168px 0px 335px", "-722px",  "6", "2", "18", "6", "6"], 
	"43": ["Lighter (Open)", 				  				   "Um isqueiro que está com fluído.<br>Serve para acender lareiras em cemitérios e queimar cordas cheias de óleo.", 																		 																		"0px 114px 0px 392px", "-833px",  "6", "2", "19", "7", "6"], 
	...
	"49": ["(BOTU) Remote control with Batteries",      	   "BOTU!<br><br>Um Controle remoto que está sem pilhas.<br>Pelo que dá a entender, ele seria usado na farmácia para ver qual seria a senha (Aquacure, Safsprin ou Adravil).<br><br>Item descartado durante o processo de desenvolvimento.",						"0px 335px 0px 168px", "-390px",   "7", "3", "5", "3", "7"], 
	"4a": ["(BOTU) Remote control without Batteries", 		   "BOTU!<br><br>Um Controle remoto que está com pilhas.<br>Pelo que dá a entender, ele seria usado na farmácia para ver qual seria a senha (Aquacure, Safsprin ou Adravil).<br><br>Item descartado durante o processo de desenvolvimento.",						"0px 280px 0px 224px", "-500px",   "7", "3", "6", "4", "7"], 
	"4b": ["(BOTU) AA Batteries",		 					   "BOTU!<br><br>Um par de pilhas que seria utilizado para combinar com o Controle Remoto Sem Pilhas. Seria usado para ligar a TV da farmácia.<br><br>Item descartado durante o processo de desenvolvimento.", 							 							"0px 227px 0px 280px", "-609px",   "7", "3", "7", "5", "7"], 
	...
	"76": ["(BOTU) Keyring with four keys",			 		   "BOTU!<br><br>Molho de chaves com uso desconhecido.<br>Creio que seja para abrir diversas portas no hospital, assim como as chaves do 1º Resident / Biohazard.<br><br>Item descartado durante o processo de desenvolvimento.", 			 						"0px 58px 0px 446px", "-943px",   "11", "5", "5", "8", "11"],
	...
	"85": ["(BOTU) Recipient with liquid inside",			   "BOT... Wait a sec...<br><br>Com o nome interno de \"Game inst. A\", esse item pode ser usado quantas vezes que pelo visto não altera nada no game.<br><br>Sim, mais um item para encher linguiça.", 													 			"0px 335px 0px 168px", "-390px", "13", "5", "19", "3", "13"]
}
