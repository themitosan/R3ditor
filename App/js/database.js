...
var ITEM = {
	...
	"01": ["Combat Knife", 									   "Faca de combate simples.<br><br>Ela pode ser bem útil quando você está com pouca / sem munição. Na mão de quem sabe usar, faz estrago!", 																								   						"0px 446px 0px 57px",   "-166px", "0", "0", "1", "1", "0"],
	...
	"03": ["Beretta M92F handgun, custom S.T.A.R.S edition",   "Sua boa e velha pistola.<br>Se trata de uma M92F versão especial da S.T.A.R.S feita pelo Kendo (R.I.P).<br><br>Diz a lenda de que aqueles que não tem vida jogam usando ela sem recarregar nenhuma vez.", 														"0px 335px 0px 168px",  "-390px", "0", "0", "3", "3", "0"],
	"04": ["Shotgun Benelli M3S", 							   "Mais conhecida como Doze / TUCHEIRA.<br>Para usar é simples: <br><br>1) Certifique-se de que ela está carregada;<br><br>2) Mire na cabeça de qualquer merda que estiver na sua frente;<br><br>3) ATIRE!", 								   						"0px 280px 0px 224px",  "-500px", "0", "0", "4", "4", "0"],
	...
	"06": ["Hk-p Grenade launcher com balas comuns", 		   "Lança granadas com balas comuns - é extremamente eficiente contra a maioria dos inimigos do game.", 																																	   						"0px 168px 0px 335px",  "-722px", "0", "0", "6", "8", "0"],
	"07": ["Hk-p Grenade launcher com balas de fogo", 		   "Lança granadas com balas de fogo - é extremamente eficiente contra a maioria dos inimigos do game.", 																																	   						"0px 114px 0px 392px",  "-833px", "0", "0", "6", "8", "0"],
	"08": ["Hk-p Grenade launcher com balas de ácido", 		   "Lança granadas com balas de ácido - é extremamente eficiente contra minhocas sedentárias que vivem no parque.", 																														   						"0px 58px 0px 446px",   "-943px", "0", "0", "6", "8", "0"],
	"09": ["Hk-p Grenade launcher com balas de gelo", 		   "Lança granadas com balas de gelo - é extremamente eficiente contra qualquer inimigo que te siga o jogo inteiro gritando \"STAAARS\" feito um condenado!", 																				   						"0px 0px 0px 501px",   "-1055px", "0", "0", "6", "8", "0"],
	"0a": ["M66 Rocket launcher", 							   "É sério que precisa de ter algo escrito aqui?<br>É UMA ROCKET LAUNCHER MANOLO!", 																																						   						"0px 502px 0px 0px",     "-54px", "1", "0", "7", "0", "1"],
	...
	"0c": ["Mine thrower", 									   "Lançador de minas - Demora um pouco para surtir efeito mas quando seu projétil explode arregaça com tudo!<br><br>Boa para usar no nemesis final!", 																					   						    "0px 392px 0px 112px",  "-277px", "1", "0", "9", "2", "1"],
	"0d": ["STI Eagle 6.0", 								   "PistolaSafada++;<br><br>Ela atira mais rápido do que a pistola comum e também tem a chance de acertar o inimigo com dano crítico, estourando a sua cabeça (zombie).<br><br>Agora me fala qual que é a utilidade de ter uma mira desse jeito em uma pistola?", 	"0px 335px 0px 168px", "-390px", "1", "0", "10", "3", "1"],
	"0e": ["M4A1 Assault rifle em modo Automático", 		   "Rifle de assalto M4A1 em modo Automático<br>Não é recomendado para assaltar bancos, só farmácias mesmo! <br><br>(O dev desse programa não endossa nenhum tipo de violência, assaltos ou até mesmo a morte - é uma piada, ok?)", 		   						"0px 280px 0px 224px", "-500px", "1", "0", "11", "4", "1"],
	"0f": ["M4A1 Assault rifle em modo Manual", 			   "Rifle de assalto M4A1 em modo Manual<br>Não é recomendado para assaltar bancos, só farmácias mesmo! <br><br>(O dev desse programa não endossa nenhum tipo de violência, assaltos ou até mesmo a morte - é uma piada, ok?)", 			   						"0px 227px 0px 280px", "-609px", "1", "0", "11", "5", "1"],
	"10": ["Western Custom M37 lever action shotgun", 		   "Doze++<br>Ela tem uma hitbox maior e consegue disparar mais rápido do que a Benelli mas em compensação não consegue disparar projéteis mais fortes.<br><br>Boa para quando estiver com diversos inimigos a frente!", 					   						"0px 168px 0px 335px", "-722px", "1", "0", "12", "6", "1"],
	"11": ["Sigpro SP 2009 com balas melhoradas", 		       "PistolaSafadaDoCarlos++<br>Em ultimo caso - quando não houver mais nada a ser feito, use essa arma!", 																																	   						"0px 114px 0px 392px",  "-833px", "1", "0", "2", "7", "1"],
	"12": ["Beretta M92F customizada com balas melhoradas",    "É a mesma pistola que a Jill usa, só que está possuída pelo Satanás.<br><br>O som do disparo machuca mais do que a própria bala!", 																									   							"0px 58px 0px 446px",   "-943px", "1", "0", "3", "8", "1"],
	"13": ["Shotgun Benelli M3S com balas melhoradas",         "Imagine uma doze que tira dano até do capeta - pois é!", 																																												   						"0px 0px 0px 501px",   "-1055px", "1", "0", "4", "9", "1"],
	"14": ["Mine thrower com balas melhoradas", 			   "Meu amigo, vem cá...<br><br>Já não basta ter uma arma que arranca tudo isso de vida dos infelizes que já morreram - para que DIABOS você quer torturar eles mais ainda?", 																   						"0px 502px 0px 0px",     "-54px", "2", "0", "9", "0", "2"],
	"15": ["Handgun bullets (9x19 parabellum)", 			   "Munição de pisolas safadas/comuns. Você consegue carregar 255 delas por slot de inventário (Por que o jogo trabalha com números de no máximo 8 bits!)", 																				   						"0px 446px 0px 57px",  "-166px", "2", "0", "13", "1", "2"],
	"16": ["Magnum bullets (.44-caliber)", 					   "Munição da arma do cão!<br><br>Ela é tão poderosa / mortal que só de você encostar você já quase morre!", 																																   						"0px 392px 0px 112px", "-277px", "2", "0", "14", "2", "2"],
	"17": ["Shotgun shells", 								   "Balas 6*2.<br><br>Também conhecida em outras terras como TUCHOS / Balas de TUCHEIRA.", 																																				   							"0px 335px 0px 168px", "-390px", "2", "0", "15", "3", "2"],
	"18": ["Grenade rounds", 								   "Munição de arrombamento simples - não queira ganhar uma dessas no peito!", 																																							   							"0px 280px 0px 224px", "-500px", "2", "0", "16", "4", "2"],
	"19": ["Flame rounds", 									   "Munição de arrombamento moderado - ideal para acender churrasqueiras com controle remoto! (Principalmente se for em um domingo a tarde...)", 																							   						"0px 227px 0px 280px", "-609px", "2", "0", "17", "5", "2"],
	"1a": ["Acid rounds", 									   "Munição de arrombamento moderado++<br><br>Ideal para exterminar qualquer tipo de vermes em <br>parques / cemitérios!", 																												   							"0px 168px 0px 335px", "-722px", "2", "0", "18", "6", "2"],
	"1b": ["Freeze rounds", 								   "Munição de arrombamento avancado++<br><br>Ideal para enfrentar seres com mais de dois metros que fazem propaganda para a marca COLGATE!", 																								   						"0px 114px 0px 392px", "-833px", "2", "0", "19", "7", "2"],
	...
	"1d": ["Assault rifle clip (5.56 NATO rounds)", 		   "Munição do Rifle de assalto M4A1.<br><br>Vem cá cidadão, você alguma vez já resolveu quantificar suas balas por porcentagem?", 																										   							"0px 0px 0px 501px",   "-1055px", "2", "1", "1", "9", "2"],
	"1e": ["Enhanced handgun bullets", 						   "Balas melhoradas de pisolas safadas / comuns.<br>Não olhe diretamente nos olhos dela, elas podem te morder.", 																															   						"0px 502px 0px 0px",     "-54px", "3", "1", "2", "0", "3"],
	"1f": ["Enhanced shotgun shells", 						   "Balas melhoradas da doze!<br><br>Diz a lenda que ela arromba qualquer merda que estiver a sua frente - então tome cuidado!", 																											   						"0px 446px 0px 57px",   "-166px", "3", "1", "3", "1", "3"],
	"20": ["First aid spray", 								   "Também conhecido como Gelol de Raccon!<br><br>Uma espirrada dessa maravilha da ciência e você está curado de quase tudo!", 																											   							"0px 392px 0px 112px",  "-277px", "3", "1", "4", "2", "3"],
	"21": ["Erva Verde", 									   "Cannabis Verde!<br><br>Cura danos de forma geral - nada demais.<br>Pode até te dar uma brisa de leve - mas não é nada que possa te deixar dopado.", 																					   						"0px 335px 0px 168px",  "-390px", "3", "1", "5", "3", "3"],
	...
	"23": ["Erva Vermelha",									   "Maconha Vermelha!<br><br>Ela sozinha não faz absolutamente nada - porém quando combinada com a verde, tem quase o potencial de impedir a terceira guerra mundial!", 																	   						"0px 227px 0px 280px",  "-609px", "3", "1", "7", "5", "3"],
	...
	"25": ["Mix de Ervas Verdes + Azuis", 					   "Cannabis Intensifies!<br><br>Te deixa meio curado e cura o veneno do seu corpo.<br>Poder de deixar doidão = 50%", 																													       						"0px 114px 0px 392px",  "-833px", "3", "1", "9", "7", "3"],
	"26": ["Mix de Ervas Verdes + Vermelhas", 				   "Cannabis Perfeita!<br><br>Só de sentir o cheiro da marofa dessas ervas já te deixa completamente curado / chapado", 																													   						"0px 58px 0px 446px",  "-943px", "3", "1", "10", "8", "3"],
	"27": ["Mix de três Ervas Verdes", 						   "Bob Marley Approves!<br><br>Mano, usa essa aqui que é da boa - Cura sua vida toda!<br>Eu vi gnomos...", 																																   						"0px 0px 0px 501px",  "-1055px", "3", "1", "11", "9", "3"],
	"28": ["Mix de 2x Ervas Verdes + Erva Azul", 			   "Orégano Diferenciado!<br><br>Cura um pouco mais do que o normal e retira o veneno do corpo.<br><br>Poder de deixar doidão = 75%", 																										   						"0px 502px 0px 0px",    "-54px", "4", "1", "12", "0", "4"],
	"29": ["Mix de todas as ervas",     					   "Santo Graal das Ervas!<br><br>Cura AIDS, Ebola, Gripe suína, Remove o tinhoso do corpo, Emprega Vagabundo, Desengravida e faz Jesus voltar.<br>ALELÚIA IRMÃO!!!", 																		   						"0px 446px 0px 57px",  "-166px", "4", "1", "13", "1", "4"],
	"2a": ["Kit de First aid spray", 						   "Kit promocional de Gelol<br><br>Com esse kit você consegue carregar três unidades de Gelol ao mesmo tempo - ideal para queimaduras, frieira e confronto contra nemesis!", 																   						"0px 392px 0px 112px", "-277px", "4", "1", "14", "2", "4"],
	...
	"2c": ["(BOTU) Medalhão na cor Vermelha",				   "BOTU!<br><br>Também conhecido como BOTUchos / Moeda da Macumba na edição Vermelha.<br><br>Item descartado durante o processo de desenvolvimento.", 																					   							"0px 280px 0px 224px", "-500px", "4", "1", "16", "4", "4"],
	"2d": ["(BOTU) Medalhão na cor Azul", 					   "BOTU!<br><br>Também conhecido como BOTUchos / Moeda da Macumba na edição Azul.<br><br>Item descartado durante o processo de desenvolvimento.", 																						   							"0px 227px 0px 280px", "-609px", "4", "1", "17", "5", "4"],
	"2e": ["(BOTU) Medalhão na cor Dourada",				   "BOTU!<br><br>Também conhecido como BOTUchos / Moeda da Macumba na edição Dourada.<br><br>Item descartado durante o processo de desenvolvimento.", 																						   						"0px 168px 0px 335px", "-722px", "4", "1", "18", "6", "4"],
	...
	"30": ["(BOTU) Lata de óleo 'Giga Oil'",    			   "BOTU!<br><br>Dizem que se você usar 1024 Latas dessa, você terá um 'Tera-Oil'.<br><br>Item descartado durante o processo de desenvolvimento.", 																						   							"0px 58px 0px 446px",   "-943px", "4", "2", "0", "8", "4"],
	...
	"32": ["Fire hook", 									   "Pé de cabra usado para abrir um alçapão no restaurante.<br><br>Existe 100% de probabilidade de um baitola aparecer assim que você usar esse item.", 																					   						"0px 502px 0px 0px",      "-54px","5", "2", "2", "0", "5"],
	"33": ["Power cable", 									   "Cabo de energia usado para fazer o bonde funcionar.<br><br>Nada como fazer uma boa e velha gambiarra na hora de mexer na parte elétrica...", 																							   						"0px 446px 0px 57px",    "-166px","5", "2", "3", "1", "5"],
	"34": ["Fuse", 											   "Fusível usado para fazer o bonde funcionar.<br><br>Até aonde eu saiba, fusíveis não tem esse tamanho nem no inferno!", 																													   						"0px 392px 0px 112px",   "-277px","5", "2", "4", "2", "5"],
	...
	"36": ["Oil Additive", 									   "VPower!<br><br>Aditivo que serve para ser misturado com o óleo encontrado no posto de gasolina.", 																																		   						"0px 280px 0px 224px",   "-500px","5", "2", "6", "4", "5"],
	"37": ["Brad Vickers' card case", 						   "Carteira do Brad Vickers.<br>Dentro dela, tem o cartão de Identificação S.T.A.R.S do defunto.", 																																		   						"0px 227px 0px 280px",   "-609px","5", "2", "7", "5", "5"],
	...
	"39": ["Machine oil", 									   "Óleo de maquina mequetrefe!<br><br>Ele sozinho não tem força nem de mover um carrinnho de rolimã para frente, mas quando combinado com o Aditivo, move até a Apollo 11 para a lua!", 													   						"0px 114px 0px 392px",   "-833px","5", "2", "9", "7", "5"],
	"3a": ["Mixed oil", 									   "Óleo aditivado com VPower!<br><br>Com essa mistura você consegue fazer qualquer bonde de Raccon City que esteja especificamente em Downtown se mover!", 																				   						"0px 58px 0px 446px",   "-943px","5", "2", "10", "8", "5"],
	...
	"3f": ["Fire hose", 									   "Mangueira de incêndio usada para apagar o fogo em um corredor em uptown.<br><br>Graças a deus é a versão inteira da mangueira!", 																										 						"0px 335px 0px 168px", "-390px",  "6", "2", "15", "3", "6"], 
	...
	"41": ["Lighter oil", 									   "Flúido de isqueiro.<br><br>Usado adivinha aonde?<br><br>Em um isqueiro vazio! (Duuuuur~~~)", 																																			 						"0px 227px 0px 280px", "-609px",  "6", "2", "17", "5", "6"], 
	"42": ["Lighter (Fechado / Sem fluído)", 				   "Um isqueiro que está sem fluído.<br>(Não presta para acender cigarro derby)", 																																							 						"0px 168px 0px 335px", "-722px",  "6", "2", "18", "6", "6"], 
	"43": ["Lighter (Aberto / Com fluído)", 				   "Um isqueiro que está com fluído.<br>Serve para acender lareiras em cemitérios e queimar cordas cheias de óleo. <br><br>(Não serve para acender cigarro derby)", 																		 						"0px 114px 0px 392px", "-833px",  "6", "2", "19", "7", "6"], 
	...
	"75": ["Emblem (S.T.A.R.S) key", 						   "Chave usada para abrir a clássica sala S.T.A.R.S na delegacia RPD.<br><br>Normalmente depois de usar essa chave você aperta \"F9\", visto que deu RNG ruim (mais uma vez)", 															 						"0px 114px 0px 392px", "-833px",  "11", "5", "4", "7", "11"],
	...
	"7d": ["Park (rear gate) key", 							   "Chave de um cadeado.<br>Com essa chave você consegue abrir um cadeado que está impedindo a passagem para a fabrica abandonada.<br><br>(Bem que a Jill poderia usar o Lockpick...)", 													 						"0px 227px 0px 280px", "-609px", "12", "5", "11", "5", "12"],
	...
	"82": ["Reloading tool", 								   "Uma das maravilas do século 21 - com esse item, você consegue criar munição através das polvoras.", 																																	 						"0px 502px 0px 0px", "-54px",    "13", "5", "16", "0", "13"],
...
var MSG_DICIONARIO = {
	...
	"55": [false, "y"],
	"56": [false, "z"],
	"57": [false, "(Char ou Função Não-Mapeada Nº 00)"],
	"58": [false, "(Char ou Função Não-Mapeada Nº 01)"],
	"59": [false, "(Char ou Função Não-Mapeada Nº 02)"],
	"5a": [false, "(Char ou Função Não-Mapeada Nº 03)"],
	"5b": [false, "(Char ou Função Não-Mapeada Nº 04)"],
	"5c": [false, "(Char ou Função Não-Mapeada Nº 05)"],
	"5d": [false, "(Char ou Função Não-Mapeada Nº 06)"],
	"5e": [false, "(Char ou Função Não-Mapeada Nº 07)"],
	"5f": [false, "(Char ou Função Não-Mapeada Nº 08)"],
	"60": [false, "(Char ou Função Não-Mapeada Nº 09)"],
	"61": [false, "(Char ou Função Não-Mapeada Nº 10)"],
	"62": [false, "(Char ou Função Não-Mapeada Nº 11)"],
	"63": [false, "(Char ou Função Não-Mapeada Nº 12)"],
	"64": [false, "(Char ou Função Não-Mapeada Nº 13)"],
	"65": [false, "(Char ou Função Não-Mapeada Nº 14)"],
	"66": [false, "(Char ou Função Não-Mapeada Nº 15)"],
	"67": [false, "(Char ou Função Não-Mapeada Nº 16)"],
	"68": [false, "(Char ou Função Não-Mapeada Nº 17)"],
	"69": [false, "(Char ou Função Não-Mapeada Nº 18)"],
	"6a": [false, "(Char ou Função Não-Mapeada Nº 19)"],
	"6b": [false, "(Char ou Função Não-Mapeada Nº 20)"],
	"6c": [false, "(Char ou Função Não-Mapeada Nº 21)"],
	"6d": [false, "(Char ou Função Não-Mapeada Nº 22)"],
	"6e": [false, "(Char ou Função Não-Mapeada Nº 23)"],
	"6f": [false, "(Char ou Função Não-Mapeada Nº 24)"],
	"70": [false, "(Char ou Função Não-Mapeada Nº 25)"],
	"71": [false, "(Char ou Função Não-Mapeada Nº 26)"],
	"72": [false, "(Char ou Função Não-Mapeada Nº 27)"],
	"73": [false, "(Char ou Função Não-Mapeada Nº 28)"],
	"74": [false, "(Char ou Função Não-Mapeada Nº 29)"],
	"75": [false, "(Char ou Função Não-Mapeada Nº 30)"],
	"76": [false, "(Char ou Função Não-Mapeada Nº 31)"],
	"77": [false, "(Char ou Função Não-Mapeada Nº 32)"],
	"78": [false, "(Char ou Função Não-Mapeada Nº 33)"],
	"79": [false, "(Char ou Função Não-Mapeada Nº 34)"],
	"7a": [false, "(Char ou Função Não-Mapeada Nº 35)"],
	"7b": [false, "(Char ou Função Não-Mapeada Nº 36)"],
	"7c": [false, "(Char ou Função Não-Mapeada Nº 37)"],
	"7d": [false, "(Char ou Função Não-Mapeada Nº 38)"],
	"7e": [false, "(Char ou Função Não-Mapeada Nº 39)"],
	"7f": [false, "(Char ou Função Não-Mapeada Nº 40)"],
	"80": [false, "(Char ou Função Não-Mapeada Nº 41)"],
	"81": [false, "(Char ou Função Não-Mapeada Nº 42)"],
	"82": [false, "(Char ou Função Não-Mapeada Nº 43)"],
	"83": [false, "(Char ou Função Não-Mapeada Nº 44)"],
	"84": [false, "(Char ou Função Não-Mapeada Nº 45)"],
	"85": [false, "(Char ou Função Não-Mapeada Nº 46)"],
	"86": [false, "(Char ou Função Não-Mapeada Nº 47)"],
	"87": [false, "(Char ou Função Não-Mapeada Nº 48)"],
	"88": [false, "(Char ou Função Não-Mapeada Nº 49)"],
	"89": [false, "(Char ou Função Não-Mapeada Nº 50)"],
	"8a": [false, "(Char ou Função Não-Mapeada Nº 51)"],
	"8b": [false, "(Char ou Função Não-Mapeada Nº 52)"],
	"8c": [false, "(Char ou Função Não-Mapeada Nº 53)"],
	"8d": [false, "(Char ou Função Não-Mapeada Nº 54)"],
	"8e": [false, "(Char ou Função Não-Mapeada Nº 55)"],
	"8f": [false, "(Char ou Função Não-Mapeada Nº 56)"],
	"90": [false, "(Char ou Função Não-Mapeada Nº 57)"],
	"91": [false, "(Char ou Função Não-Mapeada Nº 58)"],
	"92": [false, "(Char ou Função Não-Mapeada Nº 59)"],
	"93": [false, "(Char ou Função Não-Mapeada Nº 60)"],
	"94": [false, "(Char ou Função Não-Mapeada Nº 61)"],
	"95": [false, "(Char ou Função Não-Mapeada Nº 62)"],
	"96": [false, "(Char ou Função Não-Mapeada Nº 63)"],
	"97": [false, "(Char ou Função Não-Mapeada Nº 64)"],
	"98": [false, "(Char ou Função Não-Mapeada Nº 65)"],
	"99": [false, "(Char ou Função Não-Mapeada Nº 66)"],
	"9a": [false, "(Char ou Função Não-Mapeada Nº 67)"],
	"9b": [false, "(Char ou Função Não-Mapeada Nº 68)"],
	"9c": [false, "(Char ou Função Não-Mapeada Nº 69)"],
	"9d": [false, "(Char ou Função Não-Mapeada Nº 70)"],
	"9e": [false, "(Char ou Função Não-Mapeada Nº 71)"],
	"9f": [false, "(Char ou Função Não-Mapeada Nº 72)"],
	"a0": [false, "(Char ou Função Não-Mapeada Nº 73)"],
	"a1": [false, "(Char ou Função Não-Mapeada Nº 74)"],
	"a2": [false, "(Char ou Função Não-Mapeada Nº 75)"],
	"a3": [false, "(Char ou Função Não-Mapeada Nº 76)"],
	"a4": [false, "(Char ou Função Não-Mapeada Nº 77)"],
	"a5": [false, "(Char ou Função Não-Mapeada Nº 78)"],
	"a6": [false, "(Char ou Função Não-Mapeada Nº 79)"],
	"a7": [false, "(Char ou Função Não-Mapeada Nº 80)"],
	"a8": [false, "(Char ou Função Não-Mapeada Nº 81)"],
	"a9": [false, "(Char ou Função Não-Mapeada Nº 82)"],
	"aa": [false, "(Char ou Função Não-Mapeada Nº 83)"],
	"ab": [false, "(Char ou Função Não-Mapeada Nº 84)"],
	"ac": [false, "(Char ou Função Não-Mapeada Nº 85)"],
	"ad": [false, "(Char ou Função Não-Mapeada Nº 86)"],
	"ae": [false, "(Char ou Função Não-Mapeada Nº 87)"],
	"af": [false, "(Char ou Função Não-Mapeada Nº 88)"],
	"b0": [false, "(Char ou Função Não-Mapeada Nº 89)"],
	"b1": [false, "(Char ou Função Não-Mapeada Nº 90)"],
	"b2": [false, "(Char ou Função Não-Mapeada Nº 91)"],
	"b3": [false, "(Char ou Função Não-Mapeada Nº 92)"],
	"b4": [false, "(Char ou Função Não-Mapeada Nº 93)"],
	"b5": [false, "(Char ou Função Não-Mapeada Nº 94)"],
	"b6": [false, "(Char ou Função Não-Mapeada Nº 95)"],
	"b7": [false, "(Char ou Função Não-Mapeada Nº 96)"],
	"b8": [false, "(Char ou Função Não-Mapeada Nº 97)"],
	"b9": [false, "(Char ou Função Não-Mapeada Nº 98)"],
	"ba": [false, "(Char ou Função Não-Mapeada Nº 99)"],
	"bb": [false, "(Char ou Função Não-Mapeada Nº 100)"],
	"bc": [false, "(Char ou Função Não-Mapeada Nº 101)"],
	"bd": [false, "(Char ou Função Não-Mapeada Nº 102)"],
	"be": [false, "(Char ou Função Não-Mapeada Nº 103)"],
	"bf": [false, "(Char ou Função Não-Mapeada Nº 104)"],
	"c0": [false, "(Char ou Função Não-Mapeada Nº 105)"],
	"c1": [false, "(Char ou Função Não-Mapeada Nº 106)"],
	"c2": [false, "(Char ou Função Não-Mapeada Nº 107)"],
	"c3": [false, "(Char ou Função Não-Mapeada Nº 108)"],
	"c4": [false, "(Char ou Função Não-Mapeada Nº 109)"],
	"c5": [false, "(Char ou Função Não-Mapeada Nº 110)"],
	"c6": [false, "(Char ou Função Não-Mapeada Nº 111)"],
	"c7": [false, "(Char ou Função Não-Mapeada Nº 112)"],
	"c8": [false, "(Char ou Função Não-Mapeada Nº 113)"],
	"c9": [false, "(Char ou Função Não-Mapeada Nº 114)"],
	"ca": [false, "(Char ou Função Não-Mapeada Nº 115)"],
	"cb": [false, "(Char ou Função Não-Mapeada Nº 116)"],
	"cc": [false, "(Char ou Função Não-Mapeada Nº 117)"],
	"cd": [false, "(Char ou Função Não-Mapeada Nº 118)"],
	"ce": [false, "(Char ou Função Não-Mapeada Nº 119)"],
	"cf": [false, "(Char ou Função Não-Mapeada Nº 120)"],
	"d0": [false, "(Char ou Função Não-Mapeada Nº 121)"],
	"d1": [false, "(Char ou Função Não-Mapeada Nº 122)"],
	"d2": [false, "(Char ou Função Não-Mapeada Nº 123)"],
	"d3": [false, "(Char ou Função Não-Mapeada Nº 124)"],
	"d4": [false, "(Char ou Função Não-Mapeada Nº 125)"],
	"d5": [false, "(Char ou Função Não-Mapeada Nº 126)"],
	"d6": [false, "(Char ou Função Não-Mapeada Nº 127)"],
	"d7": [false, "(Char ou Função Não-Mapeada Nº 128)"],
	"d8": [false, "(Char ou Função Não-Mapeada Nº 129)"],
	"d9": [false, "(Char ou Função Não-Mapeada Nº 130)"],
	"da": [false, "(Char ou Função Não-Mapeada Nº 131)"],
	"db": [false, "(Char ou Função Não-Mapeada Nº 132)"],
	"dc": [false, "(Char ou Função Não-Mapeada Nº 133)"],
	"dd": [false, "(Char ou Função Não-Mapeada Nº 134)"],
	"de": [false, "(Char ou Função Não-Mapeada Nº 135)"],
	"df": [false, "(Char ou Função Não-Mapeada Nº 136)"],
	"e0": [false, "(Char ou Função Não-Mapeada Nº 137)"],
	"e1": [false, "(Char ou Função Não-Mapeada Nº 138)"],
	"e2": [false, "(Char ou Função Não-Mapeada Nº 139)"],
	"e3": [false, "(Char ou Função Não-Mapeada Nº 141)"],
	"e4": [false, "(Char ou Função Não-Mapeada Nº 142)"],
	"e5": [false, "(Char ou Função Não-Mapeada Nº 143)"],
	"e6": [false, "(Char ou Função Não-Mapeada Nº 144)"],
	"e7": [false, "(Char ou Função Não-Mapeada Nº 145)"],
	"e8": [false, "(Char ou Função Não-Mapeada Nº 146)"],
	"e9": [false, "(Char ou Função Não-Mapeada Nº 147)"],
	"eb": [false, "(Char ou Função Não-Mapeada Nº 148)"],
	"ec": [false, "(Char ou Função Não-Mapeada Nº 149)"],
	"ed": [false, "(Char ou Função Não-Mapeada Nº 150)"],
	"ee": [false, "(Char ou Função Não-Mapeada Nº 151)"],
	"ef": [false, "(Char ou Função Não-Mapeada Nº 152)"],
	"f1": [false, "(Char ou Função Não-Mapeada Nº 154)"],
	"f2": [false, "(Char ou Função Não-Mapeada Nº 155)"],
	"f5": [false, "(Char ou Função Não-Mapeada Nº 158)"],
	"f6": [false, "(Char ou Função Não-Mapeada Nº 159)"],
	"f7": [false, "(Char ou Função Não-Mapeada Nº 160)"],
