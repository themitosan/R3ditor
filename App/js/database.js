...
var ITEM = {
	...
	"22": ["Blue Herb", 									   "Serve para remover o veneno do corpo do personagem atual.<br><br>Se estiver jogando o NIGHTMARE MOD, combine duas para obter uma erva verde", 															   													 "0px 280px 0px 224px",  "-500px", "3", "1", "6", "4", "3",    '0px 211px 0px 168px',  '-23', '3', false],
	...
	"54": ["Unknown Sigpro SP 2009 handgun", 				   "Aka: Pistola Esquecida<br><br>Acho que os Devs resolveram colocar essas pistolas aqui só para encher o espaço mesmo, por que elas não tem nenhuma utilidade ingame.", 																	 					 "0px 280px 0px 224px", "-500px",   "8", "0", "2", "4", "8",   '0px 211px 0px 168px',  '-23', '8', false],
	"55": ["Vaccine", 										   "Vacina criada com os itens Vaccine base e Vaccine medium.<br>Use na Jill para curar ela do T-Virus.", 																																	 					 "0px 227px 0px 280px", "-609px",  "8", "3", "15", "5", "8",   '0px 170px 0px 210px',  '-65', '8', false],
	...
	"81": ["Ink ribbon", 									   "By far, it is one of the most classic items in the entire Resident Evil / Biohazard franchise.<br><br>When in inventory, you can use it on the typewriter to saving your progress.", 							 											 "0px 0px 0px 501px", "-1055px",  "12", "5", "15", "9", "12", '0px 0px 0px 378px',   '-233', '12', false],
...
var RDT_locations = {
	...
	"R202": ["Street to Alley 1",	 		   "Downtown", 	     'Street to Alley 1'],
