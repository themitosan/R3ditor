...
function save_renderBox(s_slot){
	...
	// Baú Jill
	addLog('log', 'SAVE - Loading Jill Item Box...');
	...
	while(current !== l){
		if (current > l){
			...
			if (ATTR[AT] === undefined){
				...
				addLog('log' , 'Adding item to Item Box - Jill - HEX: <font class="user-can-select">' + IT + QU + AT + NU + '</font> - Index: ' + current + ' - Item: <font title="' + IT + '">' + ITEM[IT][0] + '</font>, Quantity: ' + parseInt('0x' + QU) + ', Attr.: ' + AT + ', Second Var (aka. null): ' + NU);
			} else {
	...
	while(current !== l){
		if (current > l){
			...
			if (ATTR[AT] === undefined){
				...
				addLog('log', 'Adding item to Item Box - Carlos - HEX: <font class="user-can-select">' + IT + QU + AT + NU + '</font> - Index: ' + current + ' - Item: <font title="' + IT + '">' + ITEM[IT][0] + ', Quantity: ' + parseInt('0x' + QU) + ', Attr.: ' + AT + ', Second Var (Aka. Null) ' + NU);
			} else {
